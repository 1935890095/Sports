...
namespace XFX.Core.Scene
{
	public class SceneManager : ISceneManager
	{
		...
		private IEnumerator InstantiateSceneAsync(IScene scene)
		{
			...
			{
				AsyncOperation request2 = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(scene.name, (LoadSceneMode)1);
		...
		private void InstantiateScene(IScene scene)
		{
			...
			if (scene.option.additive)
			{
				UnityEngine.SceneManagement.SceneManager.LoadScene(scene.name, (LoadSceneMode)1);
			}
			else
			{
