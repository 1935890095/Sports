...
namespace XFX.UI.Editor
{
	...
	public class ExportNodeEditor : UnityEditor.Editor
	{
		...
		{
			node = ((UnityEditor.Editor)this).target as ExportNode;
		...
		{
			prop_name = ((UnityEditor.Editor)this).serializedObject.FindProperty("Name");
			prop_type = ((UnityEditor.Editor)this).serializedObject.FindProperty("type");
			prop_desc = ((UnityEditor.Editor)this).serializedObject.FindProperty("desc");
			prop_path = ((UnityEditor.Editor)this).serializedObject.FindProperty("path");
		}

		public override void OnInspectorGUI()
		{
			//IL_00d8: Unknown result type (might be due to invalid IL or missing references)
			((UnityEditor.Editor)this).serializedObject.Update();
			...
			if (GUI.changed)
			{
				EditorUtility.SetDirty(((UnityEditor.Editor)this).target);
			}
			((UnityEditor.Editor)this).serializedObject.ApplyModifiedProperties();
		}
	}
}
