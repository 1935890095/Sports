	...
	public abstract class Depends : RenderObject
	{
		private class Depend : RenderObject
		{
			...
			private void DoAttach(Object[] assets)
			{
				...
				{
					Object obj = asset;
					UnityEngine.Texture val = (UnityEngine.Texture)(object)((obj is UnityEngine.Texture) ? obj : null);
				...
				{
					UnityEngine.UI.Text val5 = (UnityEngine.UI.Text)(object)((obj7 is UnityEngine.UI.Text) ? obj7 : null);
					if (val5)
					{
						val5.font = font;
					}
