...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXGameLuaApiLogWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Game.LuaApi.Log);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Game.LuaApi.Log does not have a constructor!");
        }
        ...
        static int _m_Trace_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Log.Trace( _message, _args );
        ...
        static int _m_Debug_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Log.Debug( _message, _args );
        ...
        static int _m_Info_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Log.Info( _message, _args );
        ...
        static int _m_Warn_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Log.Warn( _message, _args );
        ...
        static int _m_Error_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Log.Error( _message, _args );
        ...
        static int _m_Fatal_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Log.Fatal( _message, _args );
