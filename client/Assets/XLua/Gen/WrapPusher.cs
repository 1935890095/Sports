...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineColor32
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterCaster<UnityEngine.RectTransform>(translator.Get);
			}
        }
		...
		public void Get(RealStatePtr L, int index, out UnityEngine.RectTransform val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    val = (UnityEngine.RectTransform)FastGetCSObj(L, index);
            }
			else if (type == LuaTypes.LUA_TTABLE)
			{
			    val = new UnityEngine.RectTransform();
            ...
            {
                throw new Exception("can not cast " + LuaAPI.lua_type(L, index) + " to " + typeof(UnityEngine.RectTransform));
            }
        }
	...
	public partial class StaticLuaCallbacks
    {
		...
		internal static bool __tryArraySet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int array_idx, int obj_idx)
		{
			...
			{
			    UnityEngine.RectTransform[] array = obj as UnityEngine.RectTransform[];
				translator.Get(L, obj_idx, out array[array_idx]);
				return true;
			}
            return false;
