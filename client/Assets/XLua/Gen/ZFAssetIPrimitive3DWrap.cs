...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFAssetIPrimitive3DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Asset.IPrimitive3D);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Asset.IPrimitive3D does not have a constructor!");
        }
        ...
        static int _m_SetShaderField(RealStatePtr L)
        {
		    try {
                ...
                ZF.Asset.IPrimitive3D gen_to_be_invoked = (ZF.Asset.IPrimitive3D)translator.FastGetCSObj(L, 1);
