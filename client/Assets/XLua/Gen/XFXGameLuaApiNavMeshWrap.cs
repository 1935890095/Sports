...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXGameLuaApiNavMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Game.LuaApi.NavMesh);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Game.LuaApi.NavMesh does not have a constructor!");
        }
        ...
        static int _m_AddNavMeshAgent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    XFX.Core.Render.RenderObject _renderObject = (XFX.Core.Render.RenderObject)translator.GetObject(L, 1, typeof(XFX.Core.Render.RenderObject));
                    
                        UnityEngine.AI.NavMeshAgent gen_ret = XFX.Game.LuaApi.NavMesh.AddNavMeshAgent( _renderObject );
        ...
        static int _m_AddNavMeshObstacle_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<XFX.Core.Render.RenderObject>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    XFX.Core.Render.RenderObject _renderObject = (XFX.Core.Render.RenderObject)translator.GetObject(L, 1, typeof(XFX.Core.Render.RenderObject));
                    int _shape = LuaAPI.xlua_tointeger(L, 2);
                    
                        UnityEngine.AI.NavMeshObstacle gen_ret = XFX.Game.LuaApi.NavMesh.AddNavMeshObstacle( _renderObject, _shape );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<XFX.Core.Render.RenderObject>(L, 1)) 
                {
                    XFX.Core.Render.RenderObject _renderObject = (XFX.Core.Render.RenderObject)translator.GetObject(L, 1, typeof(XFX.Core.Render.RenderObject));
                    
                        UnityEngine.AI.NavMeshObstacle gen_ret = XFX.Game.LuaApi.NavMesh.AddNavMeshObstacle( _renderObject );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Game.LuaApi.NavMesh.AddNavMeshObstacle!");
		    ...
		    try {
                ...
                
                {
                    ...
                    int _areaMask = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        bool gen_ret = XFX.Game.LuaApi.NavMesh.IsInNavMesh( _pos, _areaMask );
        ...
        static int _m_AdjustToMesh_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _radius = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector3 gen_ret = XFX.Game.LuaApi.NavMesh.AdjustToMesh( _pos, _navmask, _radius );
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    int _navmask = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.Vector3 gen_ret = XFX.Game.LuaApi.NavMesh.AdjustToMesh( _pos, _navmask );
                        translator.PushUnityEngineVector3(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Game.LuaApi.NavMesh.AdjustToMesh!");
		    ...
		    try {
                ...
                
                {
                    ...
                    int _areaMask = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        bool gen_ret = XFX.Game.LuaApi.NavMesh.CalculatePath( _source, _target, _areaMask );
                        LuaAPI.lua_pushboolean(L, gen_ret);
