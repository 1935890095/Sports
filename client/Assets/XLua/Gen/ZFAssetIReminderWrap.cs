...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFAssetIReminderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Asset.IReminder);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Asset.IReminder does not have a constructor!");
        }
        ...
        static int _g_get_anchor(RealStatePtr L)
        {
		    try {
                ...
                ZF.Asset.IReminder gen_to_be_invoked = (ZF.Asset.IReminder)translator.FastGetCSObj(L, 1);
