...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetIFaceEffectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.IFaceEffect);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.IFaceEffect does not have a constructor!");
        }
        ...
        static int _m_Show(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.IFaceEffect gen_to_be_invoked = (XFX.Asset.IFaceEffect)translator.FastGetCSObj(L, 1);
