...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXGameLuaApiUpdateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Game.LuaApi.Update);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Game.LuaApi.Update does not have a constructor!");
        }
        ...
        static int _m_Begin_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Update.Begin( _url, _version, _upversion, _onComplete, _onProgress, _onError );
		    ...
		    try {
                ...
                
                {
                    string _what = LuaAPI.lua_tostring(L, 1);
                        ...
                        object gen_ret = XFX.Game.LuaApi.Update.Get( _what );
        ...
        static int _m_Continue_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XFX.Game.LuaApi.Update.Continue(  );
        ...
        static int _m_Run_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        bool gen_ret = XFX.Game.LuaApi.Update.Run(  );
