...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFCoreRenderIRenderObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Core.Render.IRenderObject);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Core.Render.IRenderObject does not have a constructor!");
        }
        ...
        static int _m_Create(RealStatePtr L)
        {
		    try {
                ...
                {
                    ZF.Core.Render.IRenderResource _resource = (ZF.Core.Render.IRenderResource)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderResource));
        ...
        static int _m_AddChild(RealStatePtr L)
        {
		    try {
                ...
                {
                    ZF.Core.Render.IRenderObject _child = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
        ...
        static int _s_set_onComplete(RealStatePtr L)
        {
		    try {
                ...
                ZF.Core.Render.IRenderObject gen_to_be_invoked = (ZF.Core.Render.IRenderObject)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onComplete = translator.GetDelegate<System.Action<ZF.Core.Render.IRenderObject>>(L, 2);
        ...
        static int _s_set_parent(RealStatePtr L)
        {
		    try {
                ...
                ZF.Core.Render.IRenderObject gen_to_be_invoked = (ZF.Core.Render.IRenderObject)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
