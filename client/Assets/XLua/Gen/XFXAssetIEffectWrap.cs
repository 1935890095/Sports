...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetIEffectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.IEffect);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.IEffect does not have a constructor!");
        }
        ...
        static int _m_Play(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.IEffect gen_to_be_invoked = (XFX.Asset.IEffect)translator.FastGetCSObj(L, 1);
