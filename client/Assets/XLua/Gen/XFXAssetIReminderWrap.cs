...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetIReminderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.IReminder);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.IReminder does not have a constructor!");
        }
        ...
        static int _g_get_anchor(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.IReminder gen_to_be_invoked = (XFX.Asset.IReminder)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.anchor);
        ...
        static int _s_set_anchor(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.IReminder gen_to_be_invoked = (XFX.Asset.IReminder)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.anchor = LuaAPI.xlua_tointeger(L, 2);
