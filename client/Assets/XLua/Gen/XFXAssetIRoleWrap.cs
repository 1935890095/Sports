...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetIRoleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.IRole);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.IRole does not have a constructor!");
        }
        ...
        static int _m_Play(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.IRole gen_to_be_invoked = (XFX.Asset.IRole)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Asset.IRole.Play!");
        ...
        static int _m_Attach(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<XFX.Core.Render.IRenderObject>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    XFX.Core.Render.IRenderObject _robj = (XFX.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(XFX.Core.Render.IRenderObject));
                ...
                if(gen_param_count == 2&& translator.Assignable<XFX.Core.Render.IRenderObject>(L, 2)) 
                {
                    XFX.Core.Render.IRenderObject _robj = (XFX.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(XFX.Core.Render.IRenderObject));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Asset.IRole.Attach!");
        ...
        static int _m_Detach(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Asset.IRole.Detach!");
