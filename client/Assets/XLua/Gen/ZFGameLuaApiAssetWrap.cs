...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFGameLuaApiAssetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Game.LuaApi.Asset);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Game.LuaApi.Asset does not have a constructor!");
        }
        ...
        static int _m_CreateRoot_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                    
                        ZF.Asset.IRoot gen_ret = ZF.Game.LuaApi.Asset.CreateRoot( _name, _parent );
		    ...
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                        ...
                        ZF.Asset.IAudio gen_ret = ZF.Game.LuaApi.Asset.CreateAudio( _filename, _parent );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                        ...
                        ZF.Asset.IEffect gen_ret = ZF.Game.LuaApi.Asset.CreateEffect( _filename, _parent );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                        ...
                        ZF.Asset.ITexture gen_ret = ZF.Game.LuaApi.Asset.CreateTexture( _filename, _parent );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _filename = LuaAPI.lua_tostring(L, 1);
                        ...
                        ZF.Asset.IText gen_ret = ZF.Game.LuaApi.Asset.CreateText( _filename );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                        ...
                        ZF.Asset.ICanvas gen_ret = ZF.Game.LuaApi.Asset.CreateCanvas( _filename, _parent );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                        ...
                        ZF.Asset.IPrimitive3D gen_ret = ZF.Game.LuaApi.Asset.CreatePrimitive3D( _filename, _parent );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                        ...
                        ZF.Asset.ICamera gen_ret = ZF.Game.LuaApi.Asset.CreateCamera( _name, _parent );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    ZF.Core.Render.IRenderObject _parent = (ZF.Core.Render.IRenderObject)translator.GetObject(L, 2, typeof(ZF.Core.Render.IRenderObject));
                        ...
                        ZF.Asset.ILight gen_ret = ZF.Game.LuaApi.Asset.CreateLight( _name, _parent );
                        translator.PushAny(L, gen_ret);
        ...
        static int _g_get_root(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushAny(L, ZF.Game.LuaApi.Asset.root);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_viewroot(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushAny(L, ZF.Game.LuaApi.Asset.viewroot);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
