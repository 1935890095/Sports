...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFAssetIAudioWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Asset.IAudio);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Asset.IAudio does not have a constructor!");
        }
        ...
        static int _m_Play(RealStatePtr L)
        {
		    try {
                ...
                ZF.Asset.IAudio gen_to_be_invoked = (ZF.Asset.IAudio)translator.FastGetCSObj(L, 1);
