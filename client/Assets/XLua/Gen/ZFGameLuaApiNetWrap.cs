...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFGameLuaApiNetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Game.LuaApi.Net);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Game.LuaApi.Net does not have a constructor!");
        }
        ...
        static int _m_Send_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    ZF.Game.LuaApi.Net.Send( _pid, _data );
        ...
        static int _m_Connect_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    ZF.Game.LuaApi.Net.Connect( _ip, _port );
