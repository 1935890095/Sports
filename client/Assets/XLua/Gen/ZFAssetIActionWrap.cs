...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFAssetIActionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Asset.IAction);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Asset.IAction does not have a constructor!");
        }
        ...
        static int _m_Play(RealStatePtr L)
        {
		    try {
                ...
                ZF.Asset.IAction gen_to_be_invoked = (ZF.Asset.IAction)translator.FastGetCSObj(L, 1);
            
            
			    int gen_param_count = LuaAPI.lua_gettop(L);
            
                if(gen_param_count == 2&& translator.Assignable<ZF.Asset.IActionContext>(L, 2)) 
                {
                    ZF.Asset.IActionContext _context = (ZF.Asset.IActionContext)translator.GetObject(L, 2, typeof(ZF.Asset.IActionContext));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZF.Asset.IAction.Play!");
