...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFGameLuaApiSdkWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZF.Game.LuaApi.Sdk);
        ...
        {
            return LuaAPI.luaL_error(L, "ZF.Game.LuaApi.Sdk does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    ...
                    string _args = LuaAPI.lua_tostring(L, 3);
                        ...
                        string gen_ret = ZF.Game.LuaApi.Sdk.Invoke( _name, _method, _args );
        ...
        static int _m_Reported_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    ZF.Game.LuaApi.Sdk.Reported( _method, _eventName, _args );
