...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(XFX.Core.Render.IRenderObject p0)
		{
		...
		public void __Gen_Delegate_Imp1(string p0, bool p1, bool p2, float p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XFX.Asset.IRole __Gen_Delegate_Imp6(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                XFX.Asset.IRole __gen_ret = (XFX.Asset.IRole)translator.GetObject(L, errFunc + 1, typeof(XFX.Asset.IRole));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public XFX.Asset.IRole[] __Gen_Delegate_Imp7(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<XFX.Core.Render.IRenderObject>))
			{
			    return new System.Action<XFX.Core.Render.IRenderObject>(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(System.Action<string, bool, bool, float>))
			{
			    return new System.Action<string, bool, bool, float>(__Gen_Delegate_Imp1);
			}
			...
			{
			    return new System.Action<int, bool>(__Gen_Delegate_Imp4);
			}
		    ...
		    if (type == typeof(System.Func<string, XFX.Asset.IRole>))
			{
			    return new System.Func<string, XFX.Asset.IRole>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Func<string, XFX.Asset.IRole[]>))
			{
			    return new System.Func<string, XFX.Asset.IRole[]>(__Gen_Delegate_Imp7);
			}
