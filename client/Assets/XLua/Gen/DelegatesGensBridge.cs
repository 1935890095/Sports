...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(ZF.Core.Render.IRenderObject p0)
		{
		...
		public ZF.Asset.IRole __Gen_Delegate_Imp6(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                ZF.Asset.IRole __gen_ret = (ZF.Asset.IRole)translator.GetObject(L, errFunc + 1, typeof(ZF.Asset.IRole));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public ZF.Asset.IRole[] __Gen_Delegate_Imp7(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<ZF.Core.Render.IRenderObject>))
			{
			    return new System.Action<ZF.Core.Render.IRenderObject>(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(System.Func<string, ZF.Asset.IRole>))
			{
			    return new System.Func<string, ZF.Asset.IRole>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Func<string, ZF.Asset.IRole[]>))
			{
			    return new System.Func<string, ZF.Asset.IRole[]>(__Gen_Delegate_Imp7);
			}
