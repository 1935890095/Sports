...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetILightWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.ILight);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.ILight does not have a constructor!");
        }
        ...
        static int _m_Show(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.ILight gen_to_be_invoked = (XFX.Asset.ILight)translator.FastGetCSObj(L, 1);
