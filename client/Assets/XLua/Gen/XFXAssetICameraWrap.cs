...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetICameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.ICamera);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.ICamera does not have a constructor!");
        }
        ...
        static int _m_WorldToViewportPoint(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.ICamera gen_to_be_invoked = (XFX.Asset.ICamera)translator.FastGetCSObj(L, 1);
