...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetIVideoPlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.IVideoPlayer);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.IVideoPlayer does not have a constructor!");
        }
        ...
        static int _m_AddClip(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.IVideoPlayer gen_to_be_invoked = (XFX.Asset.IVideoPlayer)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Stop(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Asset.IVideoPlayer.Stop!");
