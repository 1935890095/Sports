...
namespace XLua.CSObjectWrap
{
    ...
    public class XFXAssetICanvasWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XFX.Asset.ICanvas);
        ...
        {
            return LuaAPI.luaL_error(L, "XFX.Asset.ICanvas does not have a constructor!");
        }
        ...
        static int _g_get_canvas(RealStatePtr L)
        {
		    try {
                ...
                XFX.Asset.ICanvas gen_to_be_invoked = (XFX.Asset.ICanvas)translator.FastGetCSObj(L, 1);
