...
namespace XLua {
    ...
    public partial class ObjectTranslator {
        public void PushAny<T>(RealStatePtr L, T o) 
            where T : XFX.Core.Render.IRenderObject { PushAny(L, typeof(T), o); }
        public void PushAny(RealStatePtr L, XFX.Core.Render.IRenderComponent o) { PushAny(L, typeof(XFX.Core.Render.IRenderComponent), o); }
        public void PushByType(RealStatePtr L, XFX.Core.Render.IRenderObject v) { PushAny(L, v); }
        public void PushByType(RealStatePtr L, XFX.Core.Render.IRenderComponent v) { PushAny(L, v); }
    ...
    public static class TypeExtensions2  {
        public static Type BaseType(this Type type) {
            if (type.IsInterface) {
                if (typeof(XFX.Core.Render.IRenderObject).IsAssignableFrom(type) ||
                    typeof(XFX.Core.Render.IRenderComponent).IsAssignableFrom(type)) {
	...
	public static partial class Utils {
        ...
        {
            if (type == typeof(XFX.Core.Render.IRenderObject)) {
        ...
        static int _m_AddComponent(RealStatePtr L) {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Core.Render.IRenderObject.AddComponent!");
        }
        ...
        static int _m_RemoveComponent(RealStatePtr L) {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Core.Render.IRenderObject.RemoveComponent!");
        }
        ...
        static int _m_GetComponent(RealStatePtr L) {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XFX.Core.Render.IRenderObject.GetComponent!");
        }
    }

    public partial class LuaTable {
        public void Set(string key, XFX.Core.Render.IRenderObject value) {
        ...
        public void Set(string key, XFX.Core.Render.IRenderComponent value) {
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock) {
#endif
                var L = luaEnv.L;
