...
namespace ZF.Game {
    ...
    public partial class LuaApi {
        ...
        public class PathExt {
            public static string MakeLoadPath(string name) { return ZF.Core.Util.PathExt.MakeLoadPath(name); }
            public static string MakeWWWPath(string name) { return ZF.Core.Util.PathExt.MakeWWWPath(name); }
            public static string MakeCachePath(string name) { return ZF.Core.Util.PathExt.MakeCachePath(name); }
        }
    }
    ...
    public partial class LuaApi {
        ...
        public static class Cache {
            public static string Get(string fileName) {
                string path = ZF.Core.Util.PathExt.MakeCachePath(fileName);
                if (!File.Exists(path)) {
                    return null;
                }
            ...
            public static void Save(string fileName, string content, bool cachePath = true) {
                ...
                if (!Application.isMobilePlatform && !cachePath)
                    path = ZF.Core.Util.PathExt.MakeLoadPath(fileName);
                else
                    path = ZF.Core.Util.PathExt.MakeCachePath(fileName);
    ...
    // Logger
    public partial class LuaApi {
        private static ZF.Core.Logging.ILogger logger = ZF.Game.Log.ForkChild("Lua");
    ...
    public partial class LuaApi {
        ...
        public static class Debug {
            ...
            public static void FpsStart(string type) {
                switch (type) {
                    case "screen":
                        ZF.Misc.Fps.StartScreen();
                        break;
                    case "record":
                        ZF.Misc.Fps.StartRecord();
                        break;
                    default:
                        ZF.Misc.Fps.StartScreen();
                        break;
            ...
            public static void FpsStop(string type) {
                switch (type) {
                    case "screen":
                        ZF.Misc.Fps.StopScreen();
                        break;
                    case "record":
                        ZF.Misc.Fps.StopRecord();
                        break;
                    default:
                        ZF.Misc.Fps.StopScreen();
                        break;
